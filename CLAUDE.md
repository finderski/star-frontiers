...
### Not yet started
- Phase 3 remaining combat work — apply avoidance failure Active Effects, damage application, and creature/NPC sheet integration with the extracted attack pipeline
